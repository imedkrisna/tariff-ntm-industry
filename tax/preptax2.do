...
replace year=2008
// replace mt=0 if mt==. --> replacing mt=0 bear a huge consequences unfortunately
drop t12
...
gen mtk=0,a(mt)
replace mtk=	150	if hs10==	1701110010
replace mtk=	400	if hs10==	1701110090
replace mtk=	400	if hs10==	1701120000
replace mtk=	400	if hs10==	1701910000
replace mtk=	400	if hs10==	1701991100
replace mtk=	400	if hs10==	1701991900
replace mtk=	400	if hs10==	1701999000
...
do pmk13
// update pmk 65 2011
replace mtk=450 if hs10== 1006100000
replace mtk=450 if hs10== 1006201000
replace mtk=450 if hs10== 1006209000
replace mtk=450 if hs10== 1006301500
replace mtk=450 if hs10== 1006301900
replace mtk=450 if hs10== 1006302000
replace mtk=450 if hs10== 1006303000
replace mtk=225 if hs10== 1006309000
replace mtk=450 if hs10== 1006400000
replace mtk=450 if hs10== 1102900010
// update pmk 80 2011
do pmk80
save mt11,replace
// 2012 //
